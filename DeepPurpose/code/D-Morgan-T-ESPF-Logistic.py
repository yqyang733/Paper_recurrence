...
from DeepPurpose.pybiomed_helper import _GetPseudoAAC, CalculateConjointTriad, GetQuasiSequenceOrder
...
def protein_embed(protein):
    ...
    for line in f1:
        dict_target_protein_encoding[line.split(",")[0]] = protein2espf(line.split(",")[1].strip())
