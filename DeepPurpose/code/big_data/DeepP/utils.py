...
#from DeepP.pybiomed_helper import _GetPseudoAAC, CalculateAADipeptideComposition, \
from DeepP.pybiomed_helper import _GetPseudoAAC, CalculateAADipeptideComposition, \
...
#from DeepP.chemutils import get_mol, atom_features, bond_features, MAX_NB, ATOM_FDIM, BOND_FDIM
from DeepP.chemutils import get_mol, atom_features, bond_features, MAX_NB, ATOM_FDIM, BOND_FDIM
...
from DeepP.chemutils import get_mol, atom_features, bond_features, MAX_NB
...
name2filename = {
	...
	'mpnn_cnn_kiba': 'model_mpnn_cnn_kiba',
	'transformer_cnn_bindingdb': 'model_transformer_cnn_bindingdb',
	'pretrained_models': 'DeepP_BindingDB',
	'models_configs': 'models_configs',
	'aqsoldb_cnn_model': 'AqSolDB_CNN_model',
	'aqsoldb_mpnn_model': 'AqSolDB_MPNN_model',
	'aqsoldb_morgan_model': 'AqSolDB_Morgan_model',
...
def download_pretrained_model(model_name, save_dir = './save_folder'):
	...
	if model_name.lower() in list(name2ids.keys()):
		...
		raise Exception("Given name not a pretrained model. The full list is in the Github README https://github.com/kexinhuang12345/DeepP/blob/master/README.md#pretrained-models")
